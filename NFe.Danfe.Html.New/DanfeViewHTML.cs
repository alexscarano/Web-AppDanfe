...
/*namespace NFe.Danfe.Html.New
{
    public class DanfeViewHTML
    {
        public string ObterDanfeNfe()
        {
            ...
            {
                var nfe = CrossCutting.Utils.XmlStringParaClasse<Classes.NFe>(item);
                var danfe = new DanfeNFe(nfe, Status.Autorizada, "51501045000180", "Emissor Fiscal DSBR Brasil - www.dsbrbrasil.com.br");
