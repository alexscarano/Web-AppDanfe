...
using System.Web;
using WebApplication.NFe.Models;

namespace WebApplication.NFe
{
    ...
    // Configure o gerenciador de usuários do aplicativo que é usado neste aplicativo.
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
            ...
            IOwinContext context)
        {
            ...
            manager.RegisterTwoFactorProvider("Código de email", new EmailTokenProvider<ApplicationUser>
            {
    ...
    // Configure o gerenciador de login de aplicativo que é usado neste aplicativo.  
